...
export const MOCK_PREDICTIONS = [
  ...
  {
    id: "p2",
    patientId: "PT-2026-0111",
    grade: 0,
    confidence: 0.96,
    uncertaintyScore: 0.011,
    uncertaintyFlag: false,
    status: "reviewed",
  ...
  {
    id: "p3",
    patientId: "PT-2026-0110",
    grade: 4,
    confidence: 0.63,
    uncertaintyScore: 0.081,
  ...
  {
    id: "p5",
    patientId: "PT-2026-0108",
    grade: 3,
    confidence: 0.58,
    uncertaintyScore: 0.093,
    uncertaintyFlag: true,
    status: "needs_review",
  ...
  {
    id: "p6",
    patientId: "PT-2026-0107",
    grade: 2,
    confidence: 0.79,
    uncertaintyScore: 0.048,
    uncertaintyFlag: false,
    status: "reviewed",
  ...
  {
    id: "p7",
    patientId: "PT-2026-0106",
    grade: 0,
    confidence: 0.97,
    uncertaintyScore: 0.008,
    uncertaintyFlag: false,
    status: "reviewed",
  ...
  {
    id: "p8",
    patientId: "PT-2026-0105",
    grade: 1,
    confidence: 0.84,
    uncertaintyScore: 0.031,
    uncertaintyFlag: false,
    status: "reviewed",
  ...
  {
    id: "p9",
    patientId: "PT-2026-0104",
    grade: 3,
    confidence: 0.55,
    uncertaintyScore: 0.102,
    uncertaintyFlag: true,
    status: "needs_review",
  ...
  {
    id: "p10",
    patientId: "PT-2026-0103",
    grade: 2,
    confidence: 0.88,
    uncertaintyScore: 0.039,
    uncertaintyFlag: false,
    status: "reviewed",
...
export const MOCK_NODES = [
  ...
  {
    id: "node-02",
    name: "Riverside Eye Clinic · Node 02",
    online: true,
    lastSync: "11 min ago",
    datasetSize: 2478,
  },
  {
    id: "node-03",
    name: "Northfield General · Node 03",
    online: false,
...
export const DASHBOARD_STATS = {
  ...
  averageConfidence: Math.round(
    (MOCK_PREDICTIONS.reduce((sum, p) => sum + p.confidence, 0) /
...
export const FL_ACCURACY_TREND = [...FL_ROUNDS].reverse().map((r) => ({
  day: `R${r.round}`,
  total: Math.round(r.accuracy * 100),
  flagged: Math.round(r.privacyBudget * 10),
}));
...
export const AUDIT_LOG = [
  {
    id: "a1",
    who: "asha.menon@city.health",
    what: "Reviewed scan PT-2026-0112",
    when: "12 minutes ago",
  },
  {
    id: "a2",
    who: "system",
    what: "Training round 34 completed across 3 sites",
    when: "2 hours ago",
  },
  {
    id: "a3",
    who: "daniel.roy@riverside.health",
    what: "Uploaded 4 scans",
    when: "3 hours ago",
  },
  { id: "a4", who: "system", what: "Node 03 went offline", when: "2 days ago" },
  {
    id: "a5",
    who: "asha.menon@city.health",
    what: "Changed site assignment for a colleague",
    when: "3 days ago",
  },
];
...
export const TEAM_MEMBERS = [
  ...
  },
  {
    id: "u2",
    name: "Daniel Roy",
    email: "daniel.roy@riverside.health",
    role: "Optometrist",
    node: "Node 02",
    admin: false,
    active: true,
  },
  {
    id: "u3",
    name: "Priya Nair",
    email: "priya.nair@northfield.health",
