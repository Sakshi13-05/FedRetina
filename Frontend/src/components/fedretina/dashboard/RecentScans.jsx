          ...
          <tbody>
            {rows.map((row, i) => (
              <tr
                ...
                className="fr-rise border-b border-border/60 transition-colors last:border-0 hover:bg-primary-light/60"
              >
                <td className="py-3 font-mono text-secondary-text">
                  {row.patientId}
                </td>
                <td
                  className={`py-3 font-semibold ${GRADE_COLOR_CLASS[row.grade]}`}
                >
