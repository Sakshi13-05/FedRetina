      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="flex h-16 items-center gap-3 border-b border-border bg-surface px-4 lg:hidden">
          <button
            ...
            className="flex size-11 items-center justify-center rounded-md border border-border text-secondary-text"
          >
            {drawerOpen ? (
        ...
        <main className="relative isolate mx-auto w-full max-w-[1100px] flex-1 overflow-hidden px-4 py-8 sm:px-6">
          {children}
        </main>
      </div>
    </div>
